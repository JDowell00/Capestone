# Capestone
Goal is to make a phishing detection extension that scans emails for risk of phishing attack.
...
- **Risk scoring** from 0–100 with three levels: low, medium, high
- **Readable explanations** of which patterns were detected (e.g. urgent language, suspicious links, requests for sensitive data)
- **Works with pasted text** or with **selected text from the current page**
